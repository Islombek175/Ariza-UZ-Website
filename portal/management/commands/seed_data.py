...
class Command(BaseCommand):
    ...
    def add_arguments(self,p): p.add_argument("--reset-admin-password",action="store_true")
    def handle(self,*args,**opts):
        ...
        username=os.getenv("DEFAULT_ADMIN_USERNAME","admin");password=os.getenv("DEFAULT_ADMIN_PASSWORD","admin123")
